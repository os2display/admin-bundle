 ...
 */
angular.module('ikShared').directive('ikActionReloadScreen', ['$http', 'busService',
  function ($http, busService) {
    ...
    return {
      ...
      templateUrl: 'bundles/os2displayadmin/apps/ikShared/elements/actionReloadScreen/action-reload-screen.html?' + window.config.version
    };
  }
]);
